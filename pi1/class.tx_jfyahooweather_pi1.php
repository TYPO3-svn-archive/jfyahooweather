...
require_once ("typo3conf/ext/jfyahooweather/pi1/class.yahoo_api_resolver.php");

/**
 * Plugin 'Yahoo Weather Widget' for the 'jfyahooweather' extension.
 *
 * @author	Juergen Furrer <juergen.furrer@gmail.com>
 * @package	TYPO3
 * @subpackage	tx_jfyahooweather
 */
class tx_jfyahooweather_pi1 extends tslib_pibase {
	var $prefixId = 'tx_jfyahooweather_pi1';
	// Same as class name
	var $scriptRelPath = 'pi1/class.tx_jfyahooweather_pi1.php';
	// Path to this script relative to the extension dir.
	var $extKey = 'jfyahooweather';
	// The extension key.
	...
	function main($content, $conf) {
		...
		$yahooapi->setCachePath(t3lib_div::getFileAbsFileName("uploads/tx_jfyahooweather"));
	...
	function bootstrap() {
		...
		$this->base_path = t3lib_extMgm::siteRelPath('jfyahooweather');
	...
	function renderWeather($marker,$mode) {
		...
		if (isset($this->conf['templateFile']))
			...
			$path = 'EXT:jfyahooweather_dev/template/template.html';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfyahooweather_dev/pi1/class.tx_jfyahooweather_dev_pi1.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/jfyahooweather_dev/pi1/class.tx_jfyahooweather_dev_pi1.php']);
}
?>